...
LABEL_SIZE = 1    #表示的意思是标签只有一位，cifar10中是0-9之间的一个数字
IMAGE_SIZE = 32    #cifar10数据集图片大小是32*32的
NUM_CHANNELS = 3    #因为cifar10数据集中的图片是RGB彩色图片,因此有R，G，B三个通道
PIXEL_DEPTH = 255    #像素值R，G，B最大是255
NUM_CLASSES = 10    #总共有10个类

"""
我们知道cifar10数据集下载下来你会发现有data_batch_1.bin，data_batch_2.bin....data_batch_5.bin五个作为训练，
test_batch.bin作为测试，每一个文件都是10000张图片，因此50000张用于训练，10000张用于测试
"""
TRAIN_NUM = 10000
TRAIN_NUMS = 50000
TEST_NUM = 10000
